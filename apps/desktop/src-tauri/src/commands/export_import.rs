...
use crate::models::db::{DbChat, DbMessage};
...
fn iso8601_now() -> String {
    let secs = uni_common::now_unix_secs();
...
async fn import_single_chat(
    ...
    let new_chat_id = uni_common::generate_id();
    ...
    for msg in messages {
        let new_msg_id = uni_common::generate_id();
