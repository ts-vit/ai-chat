...
export function VpnSection({
    ...
    const [mode, setMode] = useState<string>("ssh");
    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            if (sshAuthType === "key" && sshKeyPath) {
                // Read key file content - pass path to backend which will read it
    ...
    return (
        <Stack gap="lg">
            ...
            <SegmentedControl
                ...
                onChange={setMode}
                data={[
                    { value: "ssh", label: t("settings.vpn.sshTunnel") },
                    { value: "manual", label: t("settings.vpn.manualProxy") },
                ]}
            />
